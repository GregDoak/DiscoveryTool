        ...
        <div class="block">
            <div class="symfony-block-content">
                ...
                <?php if (count($majorProblems)): ?>
                    ...
                    <p>Major problems have been detected and
                        <strong>must</strong> be fixed before continuing:</p>
                    <ol>
                ...
                <?php if (count($minorProblems)): ?>
                    ...
                    <p>
                        <?php if (count(
                          $majorProblems
                        )): ?>Additionally, to<?php else: ?>To<?php endif; ?>
                ...
                <?php if ($symfonyRequirements->hasPhpIniConfigIssue()): ?>
                    <p id="phpini">*
                        <?php if ($symfonyRequirements->getPhpIniConfigPath()
                            ...
                            Changes to the
                            <strong>php.ini</strong> file must be done in "
                            <strong><?php echo $symfonyRequirements->getPhpIniConfigPath(
                                ) ?></strong>".
                        <?php else: ?>
                            To change settings, create a "
                ...
                <?php if (!count($majorProblems) && !count($minorProblems)): ?>
                    <p class="ok">All checks passed successfully. Your system is
                        ready to run Symfony applications.</p>
                <?php endif; ?>

                <ul class="symfony-install-continue">
                    <?php if (count($majorProblems) || count(
                        $minorProblems
                      )
                    ): ?>
